...
MODIS \cite{remer2005modis}, AVIRIS, MISR \cite{kahn2010maisr}, and GOME
...
liou2002introduction}, and the uncertainty propagation in
...
combined with the general Bayesian-inverse machinery of
Tarantola \cite{tarantola2005inverse} would give
posterior-distribution outputs more appropriate than the present
first-order propagation. Hooks for this are present in
\texttt{\_uncertainty.monte\_carlo} but not yet exposed in the
public API.
